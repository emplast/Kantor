...
<div class="container">
    <?php echo form_open('index.php/EditUserAdmin/edit', array('id' => 'form_2')); ?>
        ...
        <div class="box box-primary  pull-left" id="box_1">
            <div class="box-body box-profile">
                ...
                <ul class="list-group list-group-unbordered">
                    ...
                    <li class="list-group-item">
                        <b>Login</b> <a class="pull-right"><?php echo form_input(array('id' => 'part_3', 'name' => 'part_3', 'type' => 'text', 'value' => $load['login'])); ?></a>
                    </li>
                    <li class="list-group-item">
...
<?php echo form_open('index.php/EditPasswordAdmin/editUserPassword'); ?>
